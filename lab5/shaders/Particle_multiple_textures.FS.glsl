...
void main()
{
    ...
    if (fire_stage == 0)
        tex_coord = texture_coord * vec2(0.25, 1.0);
    else if (fire_stage == 1)
        tex_coord = texture_coord * vec2(0.25, 1.0) + vec2(0.25, 0.0);
    else if (fire_stage == 2)
        tex_coord = texture_coord * vec2(0.25, 1.0) + vec2(0.5, 0.0);
    else
        tex_coord = texture_coord * vec2(0.25, 1.0) + vec2(0.75, 0.0);
